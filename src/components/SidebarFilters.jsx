    ...
    <div className="bg-white">
      <div>
        ...
        <MobileFilter
          ...
          onSetMobileFiltersOpen={setMobileFiltersOpen}
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <section aria-labelledby="products-heading" className="pb-24 pt-6">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
              {/* Filters */}
              <DesktopFilter onHandleFilter={handleFilter} />
  ...
  return (
    <Transition.Root show={mobileFiltersOpen} as={Fragment}>
      <Dialog
        ...
        onClose={onSetMobileFiltersOpen}
      >
        <Transition.Child
          as={Fragment}
            ...
            <Dialog.Panel className="relative ml-auto flex h-full w-full max-w-xs flex-col overflow-y-auto bg-white py-4 pb-12 shadow-xl">
              <div className="flex items-center justify-between px-4">
                ...
                <button
                  ...
                  onClick={() => onSetMobileFiltersOpen(false)}
                >
                            ...
                            {section.options.map((option, optionIdx) => (
                              ...
                              >
                                <input
                                  ...
                                  onChange={(e) =>
                                    onHandleFilter(e, section, option)
                                  }
...
const DesktopFilter = ({ onHandleFilter }) => {
  return (
                  ...
                  {section.options.map((option, optionIdx) => (
                    <div key={option.value} className="flex items-center">
                      <input
                        ...
                        type="checkbox"
                        defaultChecked={option.checked}
                        onChange={(e) => onHandleFilter(e, section, option)}
                        className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"
                      />
                      <label
